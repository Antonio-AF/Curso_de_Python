...
user1 = Usuario('Angelina', 'Jolie', 'angelina@gmail.com', '1332563')
user2 = Usuario('Felicity', 'Jones', 'felicity@gmail.com', '4582214')
...
if senha == confirma_senha:
    ...
    print('A senha digitada não confere...')
...
# Métodos de Classes em Python são conhecidos como Métodos Estáticos em outras linguagens.
...
user = Usuario('Felicity', 'Jones', 'felicity@gmail.com', '123654')
print(user._Usuario__gera_usuario()) # Assessor de forma ruim.
"""
...
class Usuario:
    ...
    # Conhecidos como Métodos de Classes.
    @classmethod
    def conta_usuarios(cls):
        print(f'Classe: {cls}')
        print(f'Temos {cls.contador} usuários(s) no sistema')
