...
Double Under para não gerar conflito com os nomes desses elementos na programação.o
...
atribuirá à variável __name__o valor __main__ indicando que este módulo é o módulo de execução principal.
