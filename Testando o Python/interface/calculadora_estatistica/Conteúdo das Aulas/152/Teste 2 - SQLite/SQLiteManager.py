...
class SQLiteManager(SQLManager):
    ...
    def connect_to_database(self):
        ...
        try:
            if os.path.isfile(os.path.join(os.path.abspath(os.pardir), self.database + ".db")):
                self.connection = sqlite3.connect(os.path.join(os.path.abspath(os.pardir), self.database + ".db"))
            else:
                self.connection = sqlite3.connect(os.path.join(os.path.abspath(""), self.database + ".db"))
        except:
